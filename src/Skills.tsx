...
const Skills: React.FC<SkillsProps> = ({ displayedText, isTyping, onClose }) => {
  return (
    <div
    ...
    >
      ...
      <div className="pr-8">
        ...
        <div className="w-24 h-1 mt-6 rounded-full bg-gradient-to-r from-green-400 to-emerald-500"></div>
      </div>
    </div>
  );
};
